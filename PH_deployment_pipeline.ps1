...
<#
## step 3: localisation
$SPREADSHEET_ID = '1oEdmUA5W_knyji8Ps-5Tw2SkRTWLNMHNuLpgLSuWgXA'
...
$safeguarding_path = "C:\Users\fagio\Documents\parenttext-deployment\parenttext-" + $deployment + "-repo\edits\" +  $languages[0]+ "_safeguarding.json"

node C:\Users\fagio\Documents\GitHub\safeguarding-rapidpro\add_safeguarding_to_flows.js $input_path_5 $safeguarding_path $output_path_5 $languages[0]
